...
export const USER_MODES = [
  {
    ...
    description:
      'For owners wearing many hats who need a clear picture of operational status, work, and money.',
    tone: 'command',
    density: 'high',
  ...
  },
  {
    ...
    label: 'Executive',
    description:
      'For leaders who want polished summaries, trends, and the few things that need attention.',
    tone: 'briefing',
    density: 'balanced',
  ...
  },
  {
    ...
    label: 'Creative',
    description:
      'For makers who want a more visual workspace built around story, proof, and content.',
    tone: 'editorial',
    density: 'expressive',
  ...
  },
  {
    ...
    label: 'Admin / Project',
    description:
      'For people managing timelines, tasks, approvals, and detailed follow-through.',
    tone: 'structured',
    density: 'high',
  ...
  },
  {
    ...
    label: 'Healthcare',
    description:
      'For teams that need calmer screens, clear status, and careful handoffs.',
    tone: 'calm',
    density: 'comfortable',
  ...
  },
  {
    ...
    label: 'Start-Up',
    description:
      'For fast-moving teams tracking launches, growth, product progress, and investor readiness.',
    tone: 'energetic',
    density: 'balanced',
  ...
  },
  {
    ...
    label: 'Freelance',
    description:
      'For solo work focused on clients, deliverables, time, and proof of what you shipped.',
    tone: 'personal',
    density: 'comfortable',
...
export const LAYOUT_MODES = [
  {
    id: 'SIDEBAR_COMMAND',
    label: 'Focus Sidebar',
    description: 'A left menu with a strong dashboard view for people who like everything organized.',
    icon: 'sidebar',
  ...
  },
  {
    id: 'FILTER_GRID',
    label: 'Card Browser',
    description: 'A browse-friendly layout with filters and repeatable cards.',
  ...
  },
  {
    id: 'EDGE_TILE',
    label: 'Tile Wall',
    description: 'A bold wall of tiles for quick scanning and high-energy work.',
    icon: 'grid-3x3',
  ...
  },
  {
    ...
    description: 'A clean, balanced dashboard with summary cards and detail sections.',
    icon: 'layout-grid',
  ...
  },
  {
    id: 'COMMAND_CENTER',
    label: 'Live Monitor',
    description: 'A live monitoring view that keeps the most important signals front and center.',
    icon: 'monitor-up',
  ...
  },
  {
    ...
    description: 'Separate work areas that feel lighter, softer, and easier to move through.',
  ...
  },
  {
    ...
    description: 'A more visual layout with flexible cards, story space, and varied rhythm.',
  ...
  },
  {
    id: 'MOBILE_STACK',
    label: 'Simple Stack',
    description: 'A lighter layout with easy-to-read sections and touch-friendly spacing.',
    icon: 'smartphone',
