        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-1.5 max-w-2xl leading-relaxed">
              Apphia is built to plug into the tools your industry already runs — Google and Microsoft 365, Slack, Salesforce, HubSpot, Jira, Asana, Monday, NetSuite, SAP, Workday, Stripe, healthcare PM/EHR, retail POS, logistics, devops, and more.
              One hub normalizes signals across suites so nothing important stays siloed. Connect what you use; request anything missing below.
            </p>
          </div>
        ...
        <div className="rounded-xl border border-electric-blue/25 px-6 py-5 flex gap-5 items-start"
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              The goal is near-universal coverage: email, calendar, documents, tasks, tickets, CRM, ERP, HRIS, billing, payments, inventory, marketing, social, telehealth, and custom APIs.
              Everything routes into one intelligence layer — so risks, spend, and commitments surface automatically in your Command Center.
            </p>
          </div>
