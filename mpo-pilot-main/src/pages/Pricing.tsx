...
const MODE_TAGLINES: Record<UserMode, string> = {
  founder: "Built for SMB oversight — finance, ops, and fewer surprises",
  executive: "Built for org-level reporting without the noise",
  startup: "Built for fast delivery + PMO discipline — one merged workspace",
  creative: "Built for studio-grade portfolios, CRM, and social signal",
  freelance: "Built for pipeline and kanban without enterprise stack cost",
  simple: "Built for assisted, accessible navigation",
  healthcare: "Built for HIPAA-aware practice operations",
};
