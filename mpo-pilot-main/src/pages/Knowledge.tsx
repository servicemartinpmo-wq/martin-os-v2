...
export const MODE_KITS: Record<BusinessMode, {
  ...
  creative: {
    ...
    tagline: "Ideas need structure too.",
    description: "Visual-first templates for creative agencies, design studios, and content teams. Proposal-ready, client-facing, and built for makers who want their work to land.",
    color: "hsl(300 65% 55%)",
    bg: "hsl(300 65% 55% / 0.08)",
    border: "hsl(300 65% 55% / 0.3)",
    emoji: "🎨",
    starterTemplates: ["fl1", "t3", "t4", "fl3"],
    starterSops: ["s2"],
    topFrameworks: ["Design Thinking", "Creative Brief", "Sprint Cadence", "OKR (Visual)"],
    quickWins: [
      "Create a reusable proposal template for your top 3 service types",
      "Document your creative process — it differentiates you from competitors",
      "Run a weekly team creative retro — what inspired us, what drained us",
      "Cap revisions at 2 rounds — scope it in every contract",
    ],
  },
  guided: {
    label: "Guided Start",
    tagline: "Step-by-step. No jargon. Just clarity.",
    description: "Simplified, plain-language templates with full explanations. Perfect for first-time managers, small teams, or anyone who wants clarity without complexity.",
    color: "hsl(210 55% 52%)",
    bg: "hsl(210 55% 52% / 0.08)",
    border: "hsl(210 55% 52% / 0.3)",
    emoji: "🧭",
    starterTemplates: ["t1", "t2", "t3", "t4"],
    starterSops: ["s1"],
    topFrameworks: ["PDCA (Plan-Do-Check-Act)", "SMART Goals", "RACI Matrix", "Meeting Agenda"],
    quickWins: [
      "Start with one clear goal — write it down in plain language",
      "Assign one person to own each task — clarity prevents confusion",
      "Hold a short weekly check-in — 15 minutes is enough to stay aligned",
      "Document what works — you will thank yourself later",
    ],
  },
};
...
const FORMULA_CATEGORIES = [
  {
    ...
    formulas: [
      ...
      } as FormulaCard,
      {
        ...
        description: "Maps the continuous health score (0–100) to one of five CMMI maturity levels using fixed threshold boundaries, not a linear division. Thresholds are calibrated to SEI CMMI-DEV v2.0 benchmarks.",
        variables: [
          { symbol: "H", meaning: "Org Health Score" },
          { symbol: "Level 1", meaning: "Initial / Foundational (H < 35) — processes unpredictable, ad-hoc" },
          { symbol: "Level 2", meaning: "Managed (35 ≤ H < 55) — basic project management in place" },
          { symbol: "Level 3", meaning: "Defined (55 ≤ H < 75) — processes documented and standardised" },
          { symbol: "Level 4", meaning: "Quantitatively Managed (75 ≤ H < 90) — process metrics and SPC in use" },
          { symbol: "Level 5", meaning: "Optimizing (H ≥ 90) — continuous improvement and innovation culture" },
        ],
        example: "H = 64.4",
        result: "Level 3 — Defined (55 ≤ 64.4 < 75)",
      } as FormulaCard,
    ],
  },
  {
  ...
  },
  {
    ...
    formulas: [
      ...
      {
        id: "f-priority", name: "Initiative Priority Score", notation: "P = 0.4·V + 0.3·U + 0.3·(100−E)",
        description: "Composite score (0–100) used to rank initiatives in the queue. Higher score = higher priority. Effort is inverted on the same 0–100 scale so that a high-effort item reduces priority and a low-effort item boosts it.",
        variables: [
          ...
          { symbol: "(100−E)", meaning: "Inverted effort on 0–100 scale — low effort (E=20) yields 80; high effort (E=80) yields 20" },
        ],
        example: "V = 85, U = 70, E = 40 → inverted effort = 100−40 = 60",
    ...
    formulas: [
      {
        ...
        result: "Score = 0.15×80 + 0.20×72 + 0.25×65 + 0.15×78 + 0.10×85 + 0.10×70 + 0.05×60 = 12.00 + 14.40 + 16.25 + 11.70 + 8.50 + 7.00 + 3.00 = 72.85",
      } as FormulaCard,
    ],
  },
];
    ...
    <div className="p-6 space-y-5 max-w-none">
      ...
      {isGuided ? (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <button className="self-start sm:self-auto flex items-center gap-2 text-xs px-3 py-2 rounded-lg border-2 font-semibold transition-all hover:opacity-90"
