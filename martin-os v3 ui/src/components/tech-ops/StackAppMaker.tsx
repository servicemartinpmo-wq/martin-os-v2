        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              disabled={isBuilding}
              className={cn(
                "px-4 py-2 bg-blue-500 hover:bg-blue-400 text-slate-950 font-black rounded-xl text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg active:scale-95 disabled:opacity-50",
                isBuilding && "animate-pulse"
              )}
            >
              {isBuilding ? <RefreshCw className="w-3 h-3 animate-spin" /> : <Play className="w-3 h-3" />}
