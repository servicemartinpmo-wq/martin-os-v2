  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const aiMsg: Message = {
        ...
        role: 'assistant',
        content: `Analyzing your request for the ${mode} environment. I've detected a potential optimization in your cloud resource allocation. Would you like me to initiate an autonomous scaling cycle?`,
        timestamp: new Date(),
        status: 'complete'
      };
